...
const emit = defineEmits(['update-model', 'message-sent', 'open-instructions'])
...
<template>
    <form @submit.prevent="submit" class="space-y-4">
        <!-- Model Selector & Instructions Button -->
        <div class="flex items-end space-x-3">
            ...
            <div>
                <button
                    ...
                    class="flex items-center justify-center px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors h-[42px]"
